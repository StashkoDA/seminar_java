...
//ПРЕДСТАВЛЕНИЕ
// класс выводов на экран действий по бронированию
public class BookingView implements View {
     ...
     */
    public void setObserver(ViewObserver observer){    // Метод установления наблюдателя за текущим представлением
    ...
    @Override
    public void printPenReservationTableResult(int reservationNo) {
        System.out.printf("Успешно изменена бронь столика. Номер вашей брони: #%d\n", reservationNo);
    }
    ...
    public void changeReservationTable(int oldReservation, Date reservationDate, int tableNo, String name){
        observer.penReservationTable(oldReservation, reservationDate, tableNo, name);
        //observer.onReservationTable(reservationDate, tableNo, name);
    }
